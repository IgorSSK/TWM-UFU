...
class History extends Component {
    ...
    searchHandler = async e => {
        ...
        const response = await api.get(`/api/classes/${ this.state.id }`)
    ...
    render(){
        const { studentName, firstResponsibleName, secondResponsibleName, address, classId, amountFaults } = this.state.class

        if(Object.values(this.state.class).length > 0)
        {
            return(
                    ...
                    <div class="col-12 col-md-10 col-lg-8">
                        <form class="card-sm" onSubmit={ this.searchHandler }>
                            <div class="card-body row no-gutters align-items-center">
                                ...
                                <div class="col">
                                    <input class="form-control form-control-lg form-control-borderless" type="search" placeholder="Search class by ID" onChange={ e => this.setState({ id: e.target.value }) }/>
                                </div>
                                <div class="col-auto">
